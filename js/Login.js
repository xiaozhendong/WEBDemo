	...
	function init(){
		...
		canvas.onmousedown=Sonmousedown;
		//canvas.onmouseover=Sonmousedown
	}

	var Sonmousedown=function(e)
	{
	...
	function draw(){
		...
		//ctx.fillText("",70,canvas.height/2-20);
		ctx.fillStyle="#fff";
		///ctx.fillText("",70,canvas.height/2+15);
		//ctx.fillText(""+((dd-15)*20/7).toFixed(2)+"%",70,canvas.height-20);
	}
